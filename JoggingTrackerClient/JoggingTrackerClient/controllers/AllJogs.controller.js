(function() {
    ...
    angular
        ...
        .controller('AllJogsController', AllJogsController);

    function AllJogsController($scope, $location, $window, $http, $rootScope, JoggingInfo, $document) {
        ...
        function getJogs(pageIndex) {
            var url = JoggingInfo.urlBase + "jogs/";
            if (pageIndex > 1)
            ...
            $http.get(url).then(function(response) {
                ...
                $scope.itemsPerPage = 10;
                 var url = JoggingInfo.urlBase + "jogs/report";
            $http.get(url).then(function(response) {
        ...
        $scope.saveJog = function() {
            if ($scope.currentJog.distance > 0 && $scope.currentJog.duration > 0) {
                ...
                $scope.error = "Please pick the distance and the duration of you jog";
        }
